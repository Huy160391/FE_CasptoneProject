...
import { Card, Tabs, Form, Input, Button, Upload, message, Row, Col, List, Tag, Rate, Spin, Table, Tooltip } from 'antd';
                    ...
                    <Tabs
                        ...
                        items={[
                            ...
                            },
                            {
                                ...
                                ), children: (<Spin spinning={ticketsLoading}>                                    {supportTickets.length > 0 ? (<Table
